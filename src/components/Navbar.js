    ...
    <div className="">
        <div className="bg-customGray-500 p-6 flex flex-row">
            ...
            <div className="ml-auto mr-16 flex flex-row">
                ...
                <p className="text-xl text-brandpink-100 font-primaryFont mt-6 mr-16">Wishlist</p>
                <Link to="" className="text-xl text-brandpink-300 font-primaryFont mt-6">Keranjang<span></span></Link>
            </div>
