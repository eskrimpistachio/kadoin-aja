    ...
    return (  
        <div className="bg-loginbg bg-cover h-full p-6 flex flex-col">
            ...
            <div className="mx-auto py-8 px-12 bg-white flex flex-col rounded-[10px]">
                ...
                <input type="text" id="phone" placeholder="Phone number or email address" className="font-logoFont rounded-lg border-brandblack border-solid border-2 p-2"/><br/>

                <label for="pass" className="font-bold font-logoFont ">Enter your Password</label><br/>
                <input type="password" id="phone" placeholder="Password" className="font-logoFont rounded-lg border-brandblack border-solid border-2 p-2"/><br/>
