        ...
        <>
            <div className="bg-black flex flex-row overflow-x-hidden">
                ...
                <div className="bg-black absolute z-40 py-16 px-8 m-28">
                    ...
                    <p className="text-brandpink-100 font-logoFont text-3xl mb-12 font-bold">Leave it to us!</p>
                    <Link to="./Product.js" className="text-white font-logoFont px-5 py-4 bg-transparent border border-solid border-white z-50 hover:text-black hover:bg-white">
            ...
            <div className="flex flex-col">
                <h1 className="text-4xl font-primaryFont mx-auto my-10 font-bold">SHOP BY CATEGORY</h1>
